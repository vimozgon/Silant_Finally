...
#######################################################
class ComplaintListView(AccessMixin, ListView):
    model = Complaint
    context_object_name = 'items'
    ...
    def get_queryset(self):
        queryset = super(ComplaintListView, self).get_queryset()
...
class ComplaintDetailView(ContextMixin, ManagerClientServiceMixin, DetailView):
    model = Complaint
    template_name = 'silant/complaint_item.html'


class ComplaintAddView(ContextMixin, AccessMixin, CreateView):
    model = Complaint
    form_class = ComplaintForm
    template_name = 'silant/complaint_edit.html'
    success_url = reverse_lazy('silant.complaint.list')

    def get_form_kwargs(self):
        kwargs = super(ComplaintAddView, self).get_form_kwargs()
        kwargs['user'] = self.request.user
        return kwargs
...
class ComplaintUpdateView(ContextMixin, ManagerServiceMixin, UpdateView):
    model = Complaint
    form_class = ComplaintForm
    template_name = 'silant/complaint_edit.html'
    success_url = reverse_lazy('silant.complaint.list')
    ...
    def get_form_kwargs(self):
        kwargs = super(ComplaintUpdateView, self).get_form_kwargs()
        kwargs['user'] = self.request.user
        return kwargs


class ComplaintDeleteView(ContextMixin, ManagerMixin, DeleteView):
    model = Complaint
    template_name = 'silant/complaint_delete.html'
    success_url = reverse_lazy('silant.complaint.list')
