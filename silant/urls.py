...
silant_urls = [
    ...
    path('openapi/complaint', ComplaintListAPIView.as_view(), name='silant.complaint.api'),
    ...
    path('complaint/', ComplaintListView.as_view(), name="silant.complaint.list"),
    path('complaint/add', ComplaintAddView.as_view(), name="silant.complaint.add"),
    path('complaint/<int:pk>', ComplaintDetailView.as_view(), name="silant.complaint.detail"),
    path('complaint/<int:pk>/edit', ComplaintUpdateView.as_view(), name="silant.complaint.update"),
    path('complaint/<int:pk>/delete', ComplaintDeleteView.as_view(), name="silant.complaint.delete"),
